    ...
    <div className="flex items-center justify-center min-h-[80vh] p-8">
      <div className="w-full max-w-[420px]">
        ...
        <p className="text-ink-2 mb-10 font-body">
          Тестовый аккаунт: <code className="font-mono text-[0.85rem]">test@test.com</code> / <code className="font-mono text-[0.85rem]">apocryph123</code>
        </p>
          ...
          <div className="flex flex-col gap-[0.4rem]">
            ...
            <div className="relative">
              <input
                ...
                className="input-base text-[1rem] p-[0.65rem_0.9rem] pr-10 w-full" placeholder="••••••"
              />
