const ru = {
  ...
  auth: {
    ...
    forgotSuccess: 'Если аккаунт с таким email существует, мы отправили ссылку для сброса пароля.',
  ...
  game: {
    ...
    keepPrivate: 'Оставить приватной',
    epilogueSubtitle: 'История завершена',
    epiloguePosts: 'постов',
    epilogueQuestion: 'Хотите опубликовать историю в Библиотеке, чтобы другие могли её прочитать?',
    epilogueContinue: 'Закрыть',
