...
const en: Translations = {
  ...
  auth: {
    ...
    forgotSuccess: 'If an account with this email exists, we have sent a password reset link.',
  ...
  game: {
    ...
    published: 'Published',
    gamePublished: 'Game published in Library',
    revokePublish: 'Revoke publication',
    finishFirst: 'Finish the game first',
    proposePublish: 'Propose publication',
    keepPrivate: 'Keep private',
    epilogueSubtitle: 'Story complete',
    epiloguePosts: 'posts',
    epilogueQuestion: 'Would you like to publish this story in the Library for others to read?',
    epilogueContinue: 'Close',
