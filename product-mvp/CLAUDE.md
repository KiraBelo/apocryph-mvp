...
- Настройки: 3 группы — Персонаж (никнейм, аватар), Оформление (раскладка, баннер), Вкладки (OOC, заметки)
...
- Публичные игры: read-only доступ к играм для всех (раздел "Публичные игры")
- Нормальная авторизация: email verification + OAuth (Google/Yandex)
- i18n: русский, английский, испанский, португальский
- Модерация: стоп-лист фраз, авто-скрытие при 2+ жалобах, админ-панель
